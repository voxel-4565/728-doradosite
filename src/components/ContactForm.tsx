...
export default function ContactForm() {
  return (
    <section id="contact" className="relative bg-[#2a3a2a]">
      <Image
        ...
        sizes="100vw"
      />
      <div className="absolute inset-0 bg-[#2a3a2a]/40" />
      <div className="relative z-10 max-w-[926px] mx-auto px-6 pt-40 lg:pt-60 pb-20 lg:pb-32">
        <ScrollReveal animation="fadeInUp">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-8 mb-16">
            <select className="bg-transparent border-b border-white text-white text-sm py-3 px-2 focus:outline-none appearance-none">
