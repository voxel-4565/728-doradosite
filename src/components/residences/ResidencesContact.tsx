...
export default function ResidencesContact() {
  return (
    <section className="relative bg-[#2a3a2a] py-20 lg:py-32">
      <Image
      ...
      <div className="relative z-10 max-w-[926px] mx-auto px-6">
        <ScrollReveal animation="fadeInUp">
          <div className="text-center mb-12">
            <h2 className="text-white text-3xl lg:text-[52.3px] font-medium font-[var(--font-inter)] leading-[1.2] mb-6">
              Welcome home to Dorado.
            </h2>
            <p className="text-white text-sm lg:text-[15.3px] tracking-[1.2px] uppercase font-normal font-[var(--font-inter)] leading-[1.9]">
              SIGN UP BELOW TO RECEIVE THE LATEST NEWS<br />
              FROM THE WELL COCONUT GROVE
            </p>
          </div>
        </ScrollReveal>
